...
#undef w4d
    ...
    __global__ void forward_kernel_shared_memory_conv(float *y, const float *x, const float *k, const int B, const int M, const int C, const int H, const int W, const int K)
    {
 ...
 */
    ...
    void forward<gpu, float>(mshadow::Tensor<gpu, 4, float> &y, const mshadow::Tensor<gpu, 4, float> &x, const mshadow::Tensor<gpu, 4, float> &w)
    {
      ...
      /* forward_kernel_shared_memory_conv<<<gridDim, blockDim>>>(y.dptr_,x.dptr_,w.dptr_, B,M,C,H,W,K); */
